<section class="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
    <ul class="flex divide-y divide-gray-200 gap-4">
        <form action="{{url()->current();}}" method="GET" class="flex items-center space-x-4">
            <input type="text" name="search" placeholder="Buscar..." class="w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
