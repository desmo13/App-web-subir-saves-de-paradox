...
<div class="flex flex-col  justify-center items-center">
        ...
        <form action="{{ route('games.store') }}" method="POST" enctype="multipart/form-data"
            class="w-1/2 bg-slate-900 rounded-md shadow-lg p-3.5">
            @csrf
            @method('POST')
            <div class="flex flex-col gap-4">
                <div>
                    <label for="title" class="block text-sm font-medium text-slate-200">Título</label>
                    <div class="mt-1">
                ...
                <div>
                    <label for="description" class="block text-sm font-medium text-slate-200">Descripción</label>
                    <div class="mt-1">
                ...
                <div class="mt-4">
                    <label for="game_name_id" class="block text-sm font-medium text-slate-200">Nombre del juego</label>
                    <div class="mt-1">
                ...
                <div>
                    <label for="public" class="block text-sm font-medium text-slate-200">¿Es público?</label>
                    ...
                    <label class="block text-sm font-medium text-slate-200 mb-1 mt-2">
                        Archivo
                    </label>
            ...
            <div class="flex justify-end gap-3 pt-4">
                ...
                <button type="button"
                    class="rounded-md border border-slate-700 px-4 py-2 text-sm text-slate-200
                               hover:border-slate-500 hover:bg-slate-900 transition"
